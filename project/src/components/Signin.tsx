      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-md p-8">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-600 to-green-500 text-white py-3 px-4 rounded-lg font-semibold hover:from-blue-700 hover:to-green-600 transition-all transform hover:scale-105 shadow-lg"
            >
              Sign In
            </button>
          </form>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <p onClick={()=>navigate('/signup')}  className="cursor-pointer inline text-blue-600 hover:text-blue-700 font-medium hover:underline">
                Sign up
              </p>
            </p>
          </div>
